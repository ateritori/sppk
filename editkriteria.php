...
<body id="page-top">
  ...
  <div class="card shadow" style="width: 50%;">
    <div class="card-header m-0 font-weight-bold" style="text-align: center; background-color: #167395; color: white">Edit Kriteria</div>
    <?php
      ...
      <div class="card-body">
        <form action="simpaneditkrit.php" method="post" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="form-group cols-sm-6">
            ...
            <input type="text" name="kriteria" style="color: black" value="<?php echo $data['nama_kriteria']; ?>" class="form-control">
          </div>

          <div class="form-group cols-sm-6">
            <label style="color: black">Bobot</label>
            <input type="number" step="any" name="bobot" style="color: black" value="<?php echo $data['bobot_kriteria']; ?>" class="form-control">
          </div>

          <div class="form-group cols-sm-6">
            <label style="color: black">Atribut</label>
            <select class="form-control" name="atribut" style="color: black">
              <option value="benefit" <?php if ($data['tipe_kriteria'] == 'benefit') {
                                        echo 'selected';
                                      } ?>>Benefit</option>
              <option value="cost" <?php if ($data['tipe_kriteria'] == 'cost') {
                                      echo 'selected';
                                    } ?>>Cost</option>
              <option value="" <?php if (is_null($data['tipe_kriteria'])) {
                                  echo 'selected';
                                } ?>>NULL</option>
            </select>
          </div>
