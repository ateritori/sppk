...
<body>
    ...
    <div class="card shadow mb-5">
        <div class="card-header py-3" style="text-align: center; background-color: #167395; color: white; font-weight:bold">Nilai Preferensi</div>
        <div class="card-body">
            <div>
                <div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style='text-align: center'>Nilai Ternormalisasi x Bobot</th>
                    ...
                    <td style='text-align: center'>";
                                    // Tampilkan nilai ternormalisasi dikali bobot untuk alternatif ini
                                    $totalTernormalisasi = 0;
                                    if (isset($matriksTernormalisasi[$id_alternatif])) {
                                        foreach ($matriksTernormalisasi[$id_alternatif] as $id_kriteria => $nilai) {
                                            $totalTernormalisasi += $nilai; // Jumlahkan semua nilai
                                        }
                                    }
                                    echo round($totalTernormalisasi, 2); // Tampilkan total
                                    echo "</td>
                    <td style='text-align: center'>" . round($nilaiPreferensi[$id_alternatif], 2) . "</td>
                  </tr>";
                                }
                                ?>
                            </tbody>
